...
Usage:
    python workbench/scripts/generate_test_data.py "cooking videos with emoji captions"
    python workbench/scripts/generate_test_data.py "edit TikToks with song lyrics" --count 10
    python workbench/scripts/generate_test_data.py "diverse mix" --count 20 --output workbench/data/sample-videos.json
"""
import asyncio
import json
import sys
