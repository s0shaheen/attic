"""Tests for agent tool functions (query_items, resolve_entity, search_similar, get_stats).

classify and analyze_visual tools were removed in pipeline v2 migration.
All classification and visual perception is now handled by the pipeline.
